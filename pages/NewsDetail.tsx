    ...
    <div className="bg-white min-h-screen animate-in fade-in duration-700">
      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        <div className="mb-12">
          <div className="flex flex-wrap items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-2 text-[9px] font-bold text-slate-400 uppercase tracking-widest">
              ...
              {newsItem.isVideo ? "Vídeo Institucional" : "4 min read"}
            </div>
          </div>
          ...
          <p
            className="text-slate-500 text-xl font-medium italic leading-relaxed border-l-4 border-[#C5A059] pl-6 mb-12"
            style={{
              whiteSpace: "pre-line",
              textAlign: "justify",
              lineHeight: "1.6",
          ...
          >
            {newsItem.Descric || newsItem.excerpt}
          </p>
        </div>

        {/* Media Container: Imagem ou Vídeo */}
        <div className="w-full aspect-video bg-black rounded-sm overflow-hidden mb-16 shadow-2xl relative">
          {newsItem.isVideo || newsItem.image.endsWith(".mp4") ? (
            <video
              controls
              className="w-full h-full object-contain"
              poster={newsItem.image}
            >
              <source src={newsItem.image} type="video/mp4" />O seu navegador
              não suporta a reprodução de vídeos.
            </video>
          ) : (
            <img
              src={newsItem.image}
        ...
        <div className="prose prose-slate max-w-none mb-20">
          <div
            className="text-slate-700 text-lg leading-relaxed space-y-8 font-medium whitespace-pre-line"
            style={{
              whiteSpace: "pre-line",
              textAlign: "justify",
              lineHeight: "1.6",
          ...
          <p
            ...
            style={{
              whiteSpace: "pre-line", // para respeitar \n
              textAlign: "justify", // para justificar o texto
              lineHeight: "1.6", // opcional, melhora leitura
              marginBottom: "1em",
            }}
          >
            {newsItem.Descric}
          ...
          <div className="bg-slate-50 border border-slate-200 p-8 rounded-sm my-12 flex flex-col md:flex-row gap-8 items-center">
            ...
            <div>
              <h4 className="text-[#003366] text-sm font-black uppercase tracking-widest mb-2">
                {t("news_authority")}
              </h4>
              <p className="text-slate-600 text-xs font-bold leading-relaxed uppercase tracking-tight">
                Secretariado Central do Comité de Gestão Coordenada de
                Fronteiras de Angola
              </p>
            </div>
          </div>
          {newsItem.imagesub && (
            <div className="w-full aspect-[16/9] bg-slate-100 rounded-sm overflow-hidden mb-16 shadow-2xl">
              <img
                src={newsItem.imagesub}
                className="w-full h-full object-cover"
                alt={newsItem.title}
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2">
                <span className="text-[9px] font-black uppercase text-slate-400 bg-slate-50 px-3 py-1 border border-slate-100">
                  Soberania
                </span>
                <span className="text-[9px] font-black uppercase text-slate-400 bg-slate-50 px-3 py-1 border border-slate-100">
                  Cooperação
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {relatedNews.map((item) => (
              ...
              >
                ...
                <div className="p-6">
                  <span className="text-[8px] font-black uppercase text-[#C5A059] mb-2 block">
                    {item.category}
                  </span>
                  <h5 className="text-[#003366] text-sm font-black uppercase italic leading-tight group-hover:text-[#C5A059] transition-colors">
                    {item.title}
                  </h5>
