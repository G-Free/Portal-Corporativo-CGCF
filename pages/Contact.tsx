    ...
    <div className="min-h-screen bg-[#f1f5f9] animate-in fade-in duration-700">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          {/* Formulário — coluna separada e larga */}
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div>
                      ...
                      <textarea title="Exposição de Motivos" required rows={5} className="w-full bg-slate-50 border border-slate-200 rounded-sm px-5 py-4 text-slate-700 outline-none font-medium text-sm focus:border-[#C5A059] transition-all resize-none"></textarea>
                    </div>
