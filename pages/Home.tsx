...
const Home: React.FC = () => {
  ...
  return (
    <div className="animate-in fade-in duration-700">
                ...
                <div className="flex items-center gap-5 mb-10">
                  ...
                  <div>
                    <h4 className="text-white text-xs font-black uppercase tracking-widest leading-tight">
                      {t("corr_agency_lobito")}
                    </h4>
                    <p className="text-slate-400 text-[9px] font-bold uppercase mt-1 tracking-wider">
                      Mecanismo de Coordenação Trilateral
                    </p>
                  </div>
                </div>
                <p className="text-slate-300 text-sm font-medium leading-relaxed mb-10 italic">
                  "Assegurar a harmonização regulamentar e de processos, com
                  metas, responsabilidades e acompanhamento regular entre os
                  três países."
                </p>
                <Link
                  to="/corredores"
                  className="group flex items-center justify-between w-full bg-white text-[#003366] px-8 py-5 text-[10px] font-black uppercase tracking-widest hover:bg-[#C5A059] hover:text-white transition-all shadow-lg"
                >
                  Aceder à Rede de Corredores{" "}
      ...
      {/* Secção de Interoperabilidade Estratégica */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-5">
              ...
              <p className="text-white text-lg font-medium leading-relaxed mb-10 italic">
              ...
              <div className="space-y-4 mb-12">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-4 text-white font-black text-[10px] uppercase tracking-widest"
                  >
      ...
      {/* News Grid - Somente 3 mais recentes */}
