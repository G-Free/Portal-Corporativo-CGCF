    ...
    <div className="animate-in fade-in duration-700">
      ...
      <section className="relative h-[650px] bg-slate-900 overflow-hidden">
        <div className="absolute inset-0">
          <img title="Angola's Border Infrastructure" src="https://images.unsplash.com/photo-1544027993-37dbfe43562a?q=80&w=2000" className="w-full h-full object-cover opacity-50" />
