...
function Navbar() {
  ...
  const navLinks = [
    { name: t("nav_home"), path: "/" },
    {
      ...
      dropdown: [
        {
          name: t("nav_about_who"),
          path: "/sobre",
          icon: Shield,
          desc: t("nav_desc_who"),
        },
        {
          name: t("nav_about_comp"),
          path: "/composicao",
          icon: LayoutGrid,
          desc: t("nav_desc_comp"),
        },
        {
          name: t("nav_about_organogram"),
          path: "/organigrama",
          icon: GitBranch,
          desc: t("nav_desc_organogram"),
        },
        {
          name: t("nav_about_coord"),
          path: "/coordenadores",
          icon: Users,
          desc: t("nav_desc_coord"),
        },
        {
          name: t("nav_about_sec"),
          path: "/secretario",
          icon: Award,
          desc: t("nav_desc_sec"),
        },
  ...
  return (
    <header className="fixed top-0 w-full z-[100]">
      ...
      >
        <div className="max-w-10xl mx-auto px-6 flex justify-between items-center">
      ...
      >
        <div className="flex flex-col h-full overflow-y-auto p-6">
          <div className="flex justify-between items-center mb-12">
            <img src={logo} alt="Logo" className="w-32 md:w-30" />
            <button title="Fechar menu" onClick={() => setIsOpen(false)}>
              <X className="w-8 h-8" />
            </button>
          </div>
